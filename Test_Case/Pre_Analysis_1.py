### Pre-Analysis for the Design of District Energy system ###
import os
import sys
import pandas as pd
import csv
...
from DES_weather_analysis import download_windsolar_data, weather_file_PDFs, scenario_generation_MCMC,scenario_analysis_MCMC,create_epws,eppy_connect_Eplus, clustring_kmediod_operation
...
if __name__ == "__main__":
    ...
    #scenario_generation_MCMC.scenario_generation_results(path_test)
    #scenario_analysis_MCMC.scenario_analysis(path_test)
