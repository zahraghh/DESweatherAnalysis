...
def read_epw(filename, coerce_year=None,FMYs=None):
    r'''
    ...
    try:
        data, meta = parse_epw(csvdata,FMYs, coerce_year)
    finally:
        csvdata.close()
    return data, meta
...
def parse_epw(csvdata,FMYs, coerce_year=None,):
    """
    ...
    return data, meta
#data, meta = read_epw('F:/Zahra/Research/Aim3/DES_weather_analysis/Test Case/ScenarioGeneration/Salt Lake City_40.758478_-111.888142_psm3_60_1998.epw')
#data, meta = read_epw('F:/Zahra/Research/Aim3/DES_weather_analysis/Test Case/ScenarioGeneration/T_0_S_0.epw')
#print(np.mean(data['temp_air']))
#print(data.iloc[0])
#a = data['global_hor_illum'][50:60]
#data.to_csv (r'F:\Zahra\Research\Aim 2\AMY_SLC.csv', index = False, header=True)
