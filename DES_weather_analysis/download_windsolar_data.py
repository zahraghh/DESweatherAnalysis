...
def download_meta_data(city):
    ...
    api_key = sam_api_key
    # Set the attributes to extract (e.g., dhi, ghi, etc.), separated by commas. (https://nrel.github.io/rex/misc/examples.nsrdb.html)
    #attributes = 'etr,etrn,ghi_infrared,ghi,dhi,dni,wind_speed,global_hor_illum,direct_normal_illum,diffuse_horizontal_illum,zenith_luminance,air_temperature,solar_zenith_angle'
